...
class webServices: UIViewController{
    ...
    public func requestPOSTresponse(link: String, VC: UIViewController){
        let url = URL(string: "https://pokeapi.co/api/v2/\(link)")!
...
//                print("response de servicio \(link): \(String(describing: responseJSON))")
